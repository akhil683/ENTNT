        ...
        <main className="flex-1 overflow-auto">
          <div className="p-8">
            <div className="text-center py-12">
              ...
              <Button onClick={() => router.push("/assessments")} className="bg-primary hover:bg-primary/90">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  {job ? `Assessment for ${job.title}` : "Edit assessment details"}
                </p>
              </div>
            </div>

            <div className="flex items-center gap-3">
              <Button variant="outline" onClick={() => setShowPreview(!showPreview)} className="bg-transparent">
                {showPreview ? (
                  <>
