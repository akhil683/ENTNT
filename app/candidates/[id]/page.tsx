...
const stages = [
  ...
  { value: "screen", label: "Screening", color: "bg-yellow-100 text-yellow-800", icon: User },
  { value: "tech", label: "Technical", color: "bg-purple-100 text-purple-800", icon: AlertCircle },
  { value: "offer", label: "Offer", color: "bg-orange-100 text-orange-800", icon: CheckCircle },
...
export default function CandidateDetailPage() {
  ...
  const renderMentions = (content: string) => {
    return content.replace(/@(\w+(?:\.\w+)?)/g, '<span class="text-primary font-medium">@$1</span>')
  }
        ...
        <main className="flex-1 overflow-auto">
          <div className="p-8">
            <div className="text-center py-12">
              <h1 className="text-2xl font-bold text-foreground mb-2">Candidate Not Found</h1>
              <p className="text-muted-foreground mb-4">
                The candidate you're looking for doesn't exist or has been removed.
              </p>
              <Button onClick={() => router.push("/candidates")} className="bg-primary hover:bg-primary/90">
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8">
          <div className="mb-6">
            <Button variant="ghost" onClick={() => router.push("/candidates")} className="mb-4">
              <ArrowLeft className="h-4 w-4 mr-2" />
              Back to Candidates
            </Button>
            ...
            <div className="flex items-start justify-between">
                ...
                <div>
                  ...
                  {job && (
                    <div className="flex items-center gap-1 mt-2">
                      ...
                      <span className="text-muted-foreground">Applied for: {job.title}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                {currentStage && (
                  <Badge className={`${currentStage.color} flex items-center gap-1`}>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="outline" className="w-[150px] justify-between bg-input" disabled={updatingStage}>
                  ...
                  <DropdownMenuContent align="end">
                    {stages.map((stage) => (
                      <DropdownMenuItem
                        key={stage.value}
                        onClick={() => handleStageChange(stage.value as CandidateStage)}
                      >
                        {stage.label}
                      </DropdownMenuItem>
                    ))}
                      ...
                      <div key={event.id} className="flex gap-3">
                        ...
                        <div className="flex-1 pb-4">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="font-medium text-card-foreground">{event.event}</span>
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-card-foreground mb-1">Application Date</p>
                  ...
                  <div>
                    <p className="text-sm font-medium text-card-foreground mb-1">Last Updated</p>
                    <p className="text-sm text-muted-foreground">{candidate.updatedAt.toLocaleDateString()}</p>
                  </div>
                  ...
                  {job && (
                    <>
                      <Separator />
                      <div>
                        <p className="text-sm font-medium text-card-foreground mb-1">Position</p>
