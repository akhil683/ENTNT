...
export default function Dashboard() {
  ...
  const recentActivity = [
    { action: "New application", candidate: "Sarah Johnson", job: "Senior Frontend Developer", time: "2 hours ago" },
    { action: "Interview scheduled", candidate: "Michael Chen", job: "Backend Engineer", time: "4 hours ago" },
    { action: "Offer sent", candidate: "Emily Davis", job: "UX Designer", time: "1 day ago" },
    { action: "Assessment completed", candidate: "David Wilson", job: "Full Stack Developer", time: "2 days ago" },
  ]
