...
import { ArrowLeft, Edit, Archive, ArchiveRestore, Users, Calendar } from "lucide-react"
        ...
        <main className="flex-1 overflow-auto">
          <div className="p-8">
            <div className="text-center py-12">
              ...
              <Button onClick={() => router.push("/jobs")} className="bg-primary hover:bg-primary/90">
        ...
        <div className="p-8">
          <div className="mb-6">
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex gap-2">
                <Button variant="outline" onClick={() => setEditModalOpen(true)} className="bg-transparent">
                  <Edit className="h-4 w-4 mr-2" />
                  Edit
                </Button>
                <Button variant="outline" onClick={handleArchiveToggle} disabled={updating} className="bg-transparent">
                  {job.status === "active" ? (
                    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle className="text-card-foreground">Job Statistics</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-3">
                    <Users className="h-5 w-5 text-primary" />
                    <div>
                      <p className="font-medium text-card-foreground">{Math.floor(Math.random() * 50) + 10}</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-card-foreground">{job.createdAt.toLocaleDateString()}</p>
                  ...
                  <div className="flex items-center gap-3">
                    <Calendar className="h-5 w-5 text-primary" />
                    <div>
                      <p className="font-medium text-card-foreground">{job.updatedAt.toLocaleDateString()}</p>
